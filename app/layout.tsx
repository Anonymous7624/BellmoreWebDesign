...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "mobile app development Long Island",
    "app developer Nassau County",
...
const structuredData = {
  ...
  description:
    "Web design, website development, website redesign, mobile app development, social media management, and business photography for small businesses in Nassau County and throughout New York.",
  url: SITE_URL,
